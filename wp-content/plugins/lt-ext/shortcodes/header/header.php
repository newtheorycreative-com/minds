...
*/					
			array(
				...
				'dependency' => array(
					'element' => 'style',
					'value' => array('header-underline', 'header-styled-sheader', 'header-subheader', 'header-with-bg', 'header-label'),
				),					
			),				
...
//					esc_html__('Theme Icon', 'lt-ext') 						=> 'theme-icon',
					...
					esc_html__('Header with small-header', 'lt-ext') 			=> 'header-subheader',
